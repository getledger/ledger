...
module.exports = {
  ...
  tenant: {
    ...
    db_name_prefix: process.env.TENANT_DB_NAME_PERFIX || 'ledger_tenant_',
   ...
   */
  hostedOnLedgerCloud: parseBoolean(
    defaultTo(process.env.HOSTED_ON_LEDGER_CLOUD, false),
    false
  ),
  ...
  s3: {
    ...
    bucket: process.env.S3_BUCKET || 'ledger-documents',
