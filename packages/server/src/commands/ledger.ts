...
// - ledger system:migrate:latest
// - ledger system:migrate:rollback
// - ledger tenants:migrate:latest
// - ledger tenants:migrate:latest --tenant_id=XXX
// - ledger tenants:migrate:rollback
// - ledger tenants:migrate:rollback --tenant_id=XXX
// - ledger tenants:migrate:make
// - ledger system:migrate:make
// - ledger tenants:list
// - ledger tenants:list --all
